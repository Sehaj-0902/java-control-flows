...
// Create a class named PowerCalculatorUsingWhileLoop
public class PowerCalculatorUsingWhileLoop {
    	public static void main(String[] args) {
        	...
        	if (number < 0 || power < 0) {
            		...
            		// Use a while loop till counter == power
            		while (counter < power) {
                		// Multiply the result by the number and assign the value to the result
                		result *= number;
